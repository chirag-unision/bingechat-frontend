  ...
  return (
    <div className='md:w-[80%] m-auto'>
        ...
        <div className='flex gap-4 flex-col md:flex-row '>
          ...
          >
                <div className={' text-secondary mx-auto  font-mono '+ (isRTCConnected.current ? '': 'hidden')}>
                  Connected to <span
                ...
                <div className={'w-full m-auto rounded-lg overflow-clip '+(isRTCConnected.current ? '': 'hidden')}>
                    <video 
            ...
            <div className={"animate-pulse duration-100 rounded-lg w-full md:h-[70%] m-auto bg-base flex "+ (isRTCConnected.current ? 'hidden': '')}>
